            ...
            <div class="bg-white rounded-xl shadow-md p-6 card-hover">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800">{{ $interfaceCount }}</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 card-hover">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800">{{ $nullableCount }}</p>
                    </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="code-block overflow-auto max-h-[600px]">
                        <pre class="text-sm p-6" style="background: #1e1e1e; color: #d4d4d4; margin: 0;">
                            <code id="typescriptCode" class="language-typescript">{{ $generatedContent ?: '// No types generated yet. Click "Generate Types" to start.' }}</code>
                        </pre>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                        ...
                        <span class="font-semibold text-purple-600" id="requiredCount">0</span>
                    </div>
                    <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                        <span class="text-gray-600">Email Fields</span>
                        <span class="font-semibold text-purple-600" id="emailCount">0</span>
                    </div>
                    <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                        <span class="text-gray-600">Unique Fields</span>
                        <span class="font-semibold text-purple-600" id="uniqueCount">0</span>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function searchInTypes() {
            ...
            if (searchTerm && code.toLowerCase().includes(searchTerm)) {
                ...
                console.log(`Found "${searchTerm}" in type definitions`);
            } else if (searchTerm) {
                showToast('Not Found', `"${searchTerm}" not found in type definitions`, 'error');
            }
        }
        ...
        function updateStats() {
            const code = document.getElementById('typescriptCode').textContent;
            const requiredMatches = code.match(/:\s*[^;]+;/g) || [];
            document.getElementById('requiredCount').textContent = requiredMatches.length;
            
            const emailMatches = code.match(/email/gi) || [];
            document.getElementById('emailCount').textContent = emailMatches.length;
            
            const uniqueMatches = code.match(/unique/gi) || [];
